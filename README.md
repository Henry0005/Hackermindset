...
A ferramenta [Exercicio5.py](https://github.com/Henry0005/Hackermindset/blob/main/Exercicio5.py "Exercicio5.py") enumera paths e arquivos utilizando wordlists sendo a padrão a [common.txt](https://github.com/Henry0005/Hackermindset/blob/main/common.txt "common.txt"), tendo a opção de trocar no código
